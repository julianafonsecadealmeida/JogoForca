...
palavras = 'FORMIGA BOLA LARANJA'.split()
...
def geraPalavraAleatoria():
 ...
 """
    Funcao que retorna uma palavra aleatoria
    """
    global palavras
...
def DicaPalavra(palavraSecreta):
        if palavraSecreta == 'FORMIGA': 
            print('DICA : Pequeno inseto')
        elif palavraSecreta == 'BOLA': 
            print('DICA : Fundamental na maioria dos esportes')
        elif palavraSecreta == 'LARANJA':
            print('DICA : É uma cor e também fruta')
        else:
            print('DICA :')
main()